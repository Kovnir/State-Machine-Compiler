...
TEST(OptimizerTest, clearEverythingBeforeAndAfterStarSlash)
{
	std::vector<Token> tokens = {
		...
		Token(TokenType::SLASH_STAR, "", 0, 0), //start
		...
		Token(TokenType::STAR_SLASH, "", 4, 0), //end
	...
	validateToken(optimized[1], TokenType::SPACE, "", 1, 0);
	validateToken(optimized[2], TokenType::STAR, "", 1, 1);
	validateToken(optimized[3], TokenType::SPACE, "", 1, 2);
	validateToken(optimized[4], TokenType::CUSTOM_NAME, "TestStateMachine", 1, 3);
	validateToken(optimized[5], TokenType::NEW_LINE, "", 1, 19);
	validateToken(optimized[6], TokenType::CUSTOM_NAME, "IdleState", 2, 4);
	validateToken(optimized[7], TokenType::DEFAULT, "", 2, 13);
}
...
TEST(OptimizerTest, clearAllSpaces)
{
	...
	validateToken(optimized[2], TokenType::CUSTOM_NAME, "IdleState", 2, 4);
	validateToken(optimized[3], TokenType::DEFAULT, "", 2, 13);
	validateToken(optimized[4], TokenType::COMMENT, " some comment  here   ", 2, 21);
	validateToken(optimized[5], TokenType::NEW_LINE, "", 2, 46);
	validateToken(optimized[6], TokenType::ON, "", 3, 5);
	validateToken(optimized[7], TokenType::CUSTOM_NAME, "Play", 3, 8);
	validateToken(optimized[8], TokenType::ARROW, "", 3, 13);
